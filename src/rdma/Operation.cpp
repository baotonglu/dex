...
// for RC & UC
// The first qp records which dest to send
...
//   wr.opcode = IBV_WR_EXT_MASKED_ATOMIC_FETCH_AND_ADD;
//   wr.send_flags = IBV_SEND_EXT_ATOMIC_INLINE;
//   wr.wr_id = wr_id;
...
//   wr.opcode = IBV_WR_EXT_MASKED_ATOMIC_CMP_AND_SWP;
//   wr.send_flags = IBV_SEND_EXT_ATOMIC_INLINE;
